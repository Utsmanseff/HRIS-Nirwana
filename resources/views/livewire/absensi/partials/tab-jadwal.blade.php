<div class="space-y-5">
    <div class="flex flex-wrap items-center gap-2.5">
        ...
        <button class="btn btn-secondary btn-sm"
                x-on:click="$store.konfirmasi.buka({ judul: 'Terapkan template pola?', pesan: @js('Jadwal '.$namaBulan.' untuk karyawan bersiklus akan ditimpa (edit manual hilang).'), varian: 'primary', labelYa: 'Terapkan', onConfirm: () => $wire.terapkanPola() })">
